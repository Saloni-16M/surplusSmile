...
const ResortForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage("");
    try {
      const res = await fetch("http://localhost:5000/api/resort/request-password-reset", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#E0F7FA] to-[#F1F8E9] p-6">
      <div className="bg-white shadow-2xl rounded-xl px-8 py-10 w-full max-w-md border border-gray-200">
        <h2 className="text-2xl font-bold text-center text-teal-700 mb-6">Resort Password Reset</h2>
...
export default ResortForgotPassword; 